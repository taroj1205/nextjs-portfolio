    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative group">
            ...
            >
              <div
                data-menu-open={mobileMenuOpen}
                className="menu-toggle before:bg-black after:bg-black data-[mode=dark]before:bg-white data-[mode=dark]after:bg-white"
              ></div>
            </button>
            {/*<div*/}
        ...
        <header className="hidden h-16 z-40 md:flex px-6 gap-4 w-full flex-row relative flex-nowrap items-center justify-between max-w-[1024px]">
          ...
          {/* Desktop menu */}
          <div className="hidden h-full md:flex gap-4 items-center justify-center">
